...
arma::vec Body::get_POSITION() {
    return POSITION;
}
arma::mat Body::get_TBI() {
    return TBI;
}
arma::vec Body::get_ANGLE_VEL() {
    return ANGLE_VEL;
}
arma::vec Body::get_ANGLE() {
    return ANGLE;
}
arma::vec Body::get_VELOCITY() {
    return VELOCITY;
}
arma::vec Body::get_ACCELERATION() {
    return ACCELERATION;
}
arma::vec Body::get_ANGLE_ACC() {
    return ANGLE_ACC;
}
arma::vec Body::get_FORCE() {
    return FORCE;
}
arma::vec Body::get_TORQUE() {
    return TORQUE;
}
arma::mat Body::get_M() {
    return M;
}
arma::vec Body::get_TBI_Q() {
    return TBI_Q;
}
arma::vec Body::get_TBID_Q() {
    return TBID_Q;
}
unsigned int Body::get_num() {
    return num;
}

void Body::set_POSITION(const arma::vec& PosIn) {
    POSITION = PosIn;
}
void Body::set_VELOCITY(const arma::vec& VelIn) {
    VELOCITY = VelIn;
}
void Body::set_ACCELERATION(const arma::vec& AccIn) {
    ACCELERATION = AccIn;
}
void Body::set_ANGLE(const arma::vec& AngIn) {
    ANGLE = AngIn;
}
void Body::set_ANGLE_VEL(const arma::vec& AngvelIn) {
    ANGLE_VEL = AngvelIn;
}
void Body::set_ANGLE_ACC(const arma::vec& AngaccIn) {
    ANGLE_ACC = AngaccIn;
}
...
Mobilized_body::Mobilized_body(unsigned int NumIn, arma::vec PosIn, arma::vec VelIn,
                               arma::vec AccIn, arma::vec AttIn, arma::vec ANG_VEL_In,
                               arma::vec ANG_ACC_In, double MIn, arma::vec IIn, arma::vec F_In,
                               arma::vec T_In) {
