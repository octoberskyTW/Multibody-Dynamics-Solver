...
Joint::Joint(unsigned int TypeIn, arma::vec piIn, arma::vec pjIn, arma::vec qiIn, arma::vec qjIn,
             BodyPtr i_In, BodyPtr j_In)
...
void Joint::Build_GAMMA() {
    ...
    GAMMA = -trans(TBI_i) * Skew_Omega_i * Skew_Omega_i * pi +
            trans(TBI_j) * Skew_Omega_j * Skew_Omega_j * pj;
}

arma::mat Joint::get_Cqi() {
    return Cqi;
}
arma::mat Joint::get_Cqj() {
    return Cqj;
}
arma::vec Joint::get_CONSTRAINT() {
    return CONSTRAINT;
}
arma::vec Joint::get_GAMMA() {
    return GAMMA;
}
arma::vec Joint::get_Pi() {
    return Pi;
}
arma::vec Joint::get_Pj() {
    return Pj;
}
arma::vec Joint::get_pi() {
    return pi;
...
BodyPtr Joint::get_body_i_ptr() {
    return body_i_ptr;
};
BodyPtr Joint::get_body_j_ptr() {
    return body_j_ptr;
};
